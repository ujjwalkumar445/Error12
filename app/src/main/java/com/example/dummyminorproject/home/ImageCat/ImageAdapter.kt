...
class ImageAdapter(private var context : Context) : RecyclerView.Adapter<ImageAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun Image(){
            ...
            Picasso.get().load(catImageModel?.imageUrl).resize(250,250).centerCrop().into(SingleImage)
        }
